...
(function () {
  ...
  function init() {
    ...
    root.innerHTML =
      ...
      '<div class="head"><div class="logo">J</div><div style="flex:1"><div class="title">매매일지</div><div class="sub">단타·체결 기록 · 붙여넣기로 한 번에 추가</div></div><a href="/" class="btn gho" style="text-decoration:none">← 배당앱</a></div>' +
      // bulk paste card
